                ...
                <n-tab-pane name="basic" tab="基础设置">
                    <div class="form-grid">
                        <n-form :model="form" label-placement="top" class="form-section">
                            ...
                            <n-grid cols="1 s:2 m:3 l:3" responsive="screen" :x-gap="16" :y-gap="16">
                                <n-gi>
                                    <n-form-item>
                                        <template #label>
                                ...
                                <n-gi span="1 s:1 m:2 l:2">
                                    <n-form-item>
                                        ...
                                        <n-space align="center" :wrap="false">
                                            ...
                                            />
                                            <n-button size="small" @click="previewCode"> 预览 </n-button>
                                            <n-input
                                                v-model:value="previewedCode"
                                                readonly
                                                placeholder="预览代码"
                                                style="width: 120px"
                                            />
...
// 移动端响应式（减少样式，主要依赖 Naive UI 栅格系统）
