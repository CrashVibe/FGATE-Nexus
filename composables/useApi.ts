...
export const useApi = () => {
    ...
    const serverApi = {
        ...
        updateServer: (id: number, data: { name: string }) => $serverAPI.Put<ApiResponse<void>>(`/servers/${id}`, data),
    ...
    const adapterApi = {
        ...
        deleteAdapter: (id: number, data: AdapterPayload) =>
            $serverAPI.Delete<ApiResponse<void>>(`/adapters/${id}`, data)
    };
